package io.vacivor.nexo.tenant.session;
...
@Controller("/api/tenant/sessions")
public class TenantSessionController {

  private final AdminSessionController delegate;

  public TenantSessionController(AdminSessionController delegate) {
